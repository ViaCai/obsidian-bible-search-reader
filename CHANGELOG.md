...
-以下两个文件是圣经数据，圣经版本为中文原注版
bible-data.json（内置的圣经数据）
bible-documents.zip（外置的圣经数据，若您需要使用其他版本的圣经，可以把你需要的版本的文字档案，如和合本.txt等丢给Ai，让AI以这个压缩包里面的文档为模板，生成符合插件要求的圣经数据）

-以下这个文件为圣经外置数据转化成内置数据的工具
build-bible-data.html（可将符合插件的66卷圣经md文档转化成内置数据）
